...
`images/logos/fall2026-city-edition.svg` is traced from the supplied artwork (only 288x240) so it stays sharp at hero size on phones, and recoloured with a light-to-dark blue gradient because the artwork's own blue (#015284) is barely 2.4:1 against the navy hero. The SVG's header comment has the colours.
